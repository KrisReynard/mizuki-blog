...
export const siteConfig: SiteConfig = {
    ...
    bilibili: {
        vmid: "223140376", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
    ...
    favicon: [
        // 留空以使用默认 favicon
        {
            src: '/assets/home/myIcon/K.jpg',    // 图标文件路径
    ...
    links: [
        {
            name: "Bilibili",
            icon: "fa7-brands:bilibili",
            url: "https://space.bilibili.com/223140376?spm_id_from=444.41.0.0",
        },
        {
            name: "GitHub",
            icon: "fa7-brands:github",
            url: "https://github.com/KrisReynard",
        },
        {
            name: "Steam",
            icon: "simple-icons:steam",
            url: "https://steamcommunity.com/id/Kris_Reynard/",
        },
    ],
    extraContacts: [
        {
        ...
        },
        {
            name: "QQ",
            icon: "fa7-brands:qq",
            value: "1517026394(有事联系)",
        },
        {
            name: "Email",
            icon: "material-symbols:mail",
            value: "2324485187@qq.com",
        },
        // {
        //     name: "WeChat",
...
export const musicPlayerConfig: MusicPlayerConfig = {
    ...
    type: "playlist", // 播单类型
    autoPlay: true, // 获取音乐后默认播放
    defaultPlayMode: "random", // 默认播放模式："random" | "repeat" | "repeat-one"
};
