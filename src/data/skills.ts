...
export const skillsData: Skill[] = [
    // Frontend Skills
    {
        ...
        // ],
        color: "rgb(98, 120, 119)",
    },
    {
        id: "html",
        name: "HTML+HTML5",
        description:
            "接触前端第一个学的东西，学的过程也一直在用",
        ...
        //     "data-visualization-tool",
        // ],
        color: "rgb(247, 157, 30)",
    },
    {
        id: "css",
        name: "CSS+CSS3",
        description:
            "懂得如何配置，但是配置项太多记不住，冷门配置仍需要看配置文件",
        ...
        //     "data-visualization-tool",
        // ],
        color: "rgb(17, 103, 207)",
    },
    {
        id: "javascript",
        name: "JavaScript",
        description:
            "学前端的时间里有一大半都用到了js，应当是掌握得最好的",
    ...
    // Backend Skills
    {
        ...
        name: "Node.js",
        description:
            "虽然在学前端的时候学了一点，但大部分情况是为了测试前后端交互，学了后端之后应当会再深入学习",
    ...
    // },
    {
        ...
        name: "Java",
        description:
            "之前学过一阵子，后来发现单学语言没什么用，决定先从前端入手学习全栈，因此熟练度不够",
        icon: "logos:java",
        category: "backend",
        level: "beginner",
        experience: { years: 2, months: 0 },
    ...
    // Database Skills
    {
        ...
        name: "MySQL",
        description:
            "大三上学的东西，实际上个人感觉AI可以代替大部分工作，人为校对一遍不会有太大问题",
